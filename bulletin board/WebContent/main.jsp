...
<!-- 
	...
	공지사항 작성 시 공지사항 게시판에 들어가지 않는다.								=> 코드 있음(채연) 적용만 하면 됨
	게시글이 10개 이상 작성시 게시글 페이지 버튼의 css가 적용되지 않는다.				=> 코드 있음(채연) 적용만 하면 됨
	게시판에서 게시글 제목을 클릭해 게시물 보기로 넘어가면 css가 적용되지 않는다			=> 이건 코드 있는지 몰?루
